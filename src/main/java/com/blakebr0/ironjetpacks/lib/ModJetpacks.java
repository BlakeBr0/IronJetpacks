...
public final class ModJetpacks {
    ...
    private static final Jetpack STONE = new Jetpack("stone", 1, 0x7F7F7F, 2, 12, "tag:c:stones", 0F, 0F);
    private static final Jetpack COPPER = new Jetpack("copper", 1, 0xEE825B, 2, 12, "minecraft:copper_ingot", 0F, 0F);
    private static final Jetpack IRON = new Jetpack("iron", 2, 0xD8D8D8, 3, 9, "tag:c:ingots/iron", 0F, 0F);
    private static final Jetpack GOLD = new Jetpack("gold", 3, 0xF9EB59, 2, 25, "tag:c:ingots/gold", 0F, 0F);
    private static final Jetpack DIAMOND = new Jetpack("diamond", 4, 0x4CF4E0, 4, 10, "tag:c:gems/diamond", 0F, 0F);
    private static final Jetpack EMERALD = new Jetpack("emerald", 5, 0x4DD979, 4, 15, "tag:c:gems/emerald", 0F, 0F);
    private static final Jetpack CREATIVE = new Jetpack("creative", 0, 0xCF1AE9, 8, 0, "null", 0F, 0F).setCreative();

    private static final Jetpack BRONZE = new Jetpack("bronze", 2, 0xDA9839, 3, 9, "tag:c:ingots/bronze", 0F, 0F);
    private static final Jetpack SILVER = new Jetpack("silver", 2, 0x8B99A4, 3, 12, "tag:c:ingots/silver", 0F, 0F);
    private static final Jetpack STEEL = new Jetpack("steel", 3, 0x565656, 3, 15, "tag:c:ingots/steel", 0F, 0F);
    private static final Jetpack ELECTRUM = new Jetpack("electrum", 3, 0xF6F395, 2, 18, "tag:c:ingots/electrum", 0F, 0F);
    private static final Jetpack INVAR = new Jetpack("invar", 3, 0xA4B2A9, 3, 15, "tag:c:ingots/invar", 0F, 0F);
    private static final Jetpack PLATINUM = new Jetpack("platinum", 4, 0xA6E9FF, 4, 12, "tag:c:ingots/platinum", 0F, 0F);
