...
public class JetpackModel extends BipedModel<LivingEntity> {
	...
	public JetpackModel(JetpackItem jetpack) {
		...
		RendererModel leftTip2 = new RendererModel(this, 0, 50).setTextureSize(64, 64);
		...
		RendererModel rightTip2 = new RendererModel(this, 17, 50).setTextureSize(64, 64);
		...
		this.energyBar1 = new RendererModel(this, 16, 55).setTextureSize(64, 64);
